...
local PALETTE_COLORS <const> = {
  [P.transparent] = Color { r = 0, g = 0, b = 0, a = 0 },
  [P.outline] = Color { r = 29, g = 43, b = 83, a = 255 },
  [P.shadow] = Color { r = 95, g = 87, b = 79, a = 255 },
  [P.body] = Color { r = 41, g = 173, b = 255, a = 255 },
  [P.highlight] = Color { r = 255, g = 241, b = 232, a = 255 },
  [P.blush] = Color { r = 255, g = 119, b = 168, a = 255 },
  [P.sparkle] = Color { r = 255, g = 236, b = 39, a = 255 },
  [P.foot] = Color { r = 255, g = 204, b = 170, a = 255 },
  [P.eye] = Color { r = 29, g = 43, b = 83, a = 255 },
  [P.eye_shine] = Color { r = 255, g = 241, b = 232, a = 255 },
}
